...
CREATE TABLE LEAVEDETAILS
    (
      ...
      Alter table EMPLOYEDETAILS drop EMP_LEAVE_BALANCE
       alter table EMPLOYEDETAILS add ML int 
    
    
    alter table EMPLOYEDETAILS add PL int 
    
    alter table EMPLOYEDETAILS add EL int 