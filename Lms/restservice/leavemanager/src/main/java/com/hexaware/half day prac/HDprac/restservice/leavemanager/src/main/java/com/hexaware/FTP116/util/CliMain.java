...
public class CliMain {
  ...
  private void mainMenu() {
    ...
    System.out.println("7. Approve Deny Hr");
    ...
    if (empId != 0) {
      ...
      if (employee == null) {
        ...
        System.out.println(employee.getEmpId() + " \t " + employee.getEmpFullName() + " \t"
            ...
            + employee.getEmpDepartment() + " \t\t " + employee.getEmpML() + " \t\t "
            + employee.getEmpPL() + " \t\t " + employee.getEmpEL() + " \t\t "
  ...
  private void appDenyHR() {
    ...
    System.out.println("approved (YES/NO) ");
    String leaveStatus = option.next();
    System.out.println("hr manager comments");
    String leaveMgrComments = option.next();
    String res = LeaveDetails.approveDenyforHR(leaveId, empManagerId, leaveStatus, leaveMgrComments);
    System.out.println(res);
  }
  ...
  private void listEmployeesDetails() {
    ...
    for (Employee e : employee) {
      System.out.println(e.getEmpId() + " \t " + e.getEmpFullName() + " \t"
          ...
          + e.getEmpDepartment() + " \t\t " + e.getEmpML() + " \t\t "
          + e.getEmpPL() + " \t\t " + e.getEmpEL() + " \t\t "
          + e.getEmpManagerId());
    }
  }
  private void applyLeave() {
    ...
    try {
      ...
      if (lt == LeaveType.EL || lt == LeaveType.PL || lt == LeaveType.ML || lt == LeaveType.OL) {
        ...
        if(lt == LeaveType.ML) {
          System.out.println("your request has been send to HR");
        }
